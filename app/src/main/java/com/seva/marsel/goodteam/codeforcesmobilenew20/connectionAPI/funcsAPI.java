...
public class funcsAPI {
    ...
    public void getUsers(String handles, final com.seva.marsel.goodteam.codeforcesmobilenew20.Callback callback){
    ...
    public void getBlog(ArrayList<String> blogEntryId, final com.seva.marsel.goodteam.codeforcesmobilenew20.Callback callback){
    ...
    public void getContests(String gym, final com.seva.marsel.goodteam.codeforcesmobilenew20.Callback callback){
